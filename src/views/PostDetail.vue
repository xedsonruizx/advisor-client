    ...
    <div class="card shadow-lg border-0 overflow-hidden">
      ...
      <div v-else class="card-body p-0">
        ...
        <div class="p-4 p-md-5">
          <div class="article-content" style="white-space: pre-line; font-size: 1.1rem; line-height: 1.8; color: #333;">
            {{ post.content }}
          </div>
          ...
          <div class="modal-body">
            <form @submit.prevent="savePost" novalidate>
              ...
              <div class="mb-3">
                ...
                <textarea v-model="postForm.content" class="form-control" rows="8" required></textarea>
              </div>
              <div class="row">
